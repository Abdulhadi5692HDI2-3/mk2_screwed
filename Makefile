CFLAGS = -Wall -fpic -ffreestanding -ggdb -g -fno-stack-protector -nostdlib -Ibase/inc -Iexternal/
...
interrupt.o:
	x86_64-elf-gcc $(CFLAGS) -mno-red-zone -mgeneral-regs-only -c base/mk2os/interrupt.c -o interrupt.o

mk2krnlos.x86_64.elf: interrupt.o
	...
	x86_64-elf-gcc $(CFLAGS) -mno-red-zone -c base/mk2os/idt.c -o idt.o
	...
	x86_64-elf-ld $(LDFLAGS) mk2krnlos.o memory.o idt.o interrupt.o tar.o font.o ioasm.o serial.o screen.o console.o printf.o -o mk2krnlos.x86_64.elf
