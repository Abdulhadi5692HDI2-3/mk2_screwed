...
' note: i had to ;) to copy the kernel.
...
Call fso.CopyFile("x64\Debug\bootloader.efi", "image\efi\boot\" & BOOT_NAME, True)
Call fso.CopyFile("x64\Debug\mk2krnlos.exe", "image\mk2krnlos.exe", True)
